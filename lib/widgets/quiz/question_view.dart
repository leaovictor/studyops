...
class QuestionView extends StatelessWidget {
  ...
  final Function(String) onToggleElimination;
  ...
  const QuestionView({
    ...
    required this.onToggleElimination,
    ...
    return Padding(
      ...
      child: ListView(
        children: [
          ...
          if (question.subjectName != null || hasAnswered)
            Row(
              children: [
              ...
              child: ClipRRect(
                ...
                child: Slidable(
                  ...
                  endActionPane: ActionPane(
                    ...
                    children: [
                      SlidableAction(
                        onPressed: (_) => onToggleElimination(optionKey),
                        ...
                        label: isEliminated ? 'Ver' : 'Eliminar',
                      ),
                    ],
                  ),
                  child: Opacity(
